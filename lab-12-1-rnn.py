...
sequence_loss = tf.contrib.seq2seq.sequence_loss(logits=outputs, targets=y_data, weights=weights)

train = tf.train.GradientDescentOptimizer(learning_rate=0.1).minimize(tf.reduce_mean(sequence_loss))
